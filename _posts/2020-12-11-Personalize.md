...
단순 테스트가 아닌 실제 서비스를 위해서는 스케쥴러, API Gateway 등 연동 부분도 고려해야 하므로 이 때는 2,3번으로 작업을 권장드리며, 지금은 1번 방법을 통해 구축 방법을 알아보겠습니다. 구축 절차는 다음과 같습니다.

* S3에 데이터 적재
* Personalize에 데이터 로드 및 스키마 설정
* 솔루션 생성
* Filter 설정
* Campaigns 생성
