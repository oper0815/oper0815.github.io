...
`Tensorflow certificate`는 구글 공인의 텐서플로우 자격증입니다. 다른 객관식형 자격증 시험과는 다르게 이 시험은 **코딩** 시험으로 텐서플로우 기반의 AI모델링에 대한 문제로 구성되어 있습니다. 시험에 대해서(문제), 자격증 준비 방법, 느낀점&팁에 대해 소개하겠습니다.
...
* 취득하면 링크드인과 무슨 certificate Network에 이름을 게재할 수 있다고 합니다.
...
<img src="/assets/images/peronsal1.JPG" width="70%" height="100%">
